...
const HeroSection = ({
  heading = "Your Money,",
  subheading = "  Your Control, Anytime, Anywhere",
  description = "A fast, secure, and reliable digital wallet for everyday transactions. Send money, pay bills, recharge, and manage your wallet seamlessly with our role-based system for Users, Agents, and Admins",
  buttons = {
    primary: {
      text: "Get Started",
      url: "/user/send-money",
