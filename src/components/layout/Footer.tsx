            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#FF3667] transition hover:text-[#FF3667]/80 dark:text-[#d8607e] dark:hover:text-[#FF3667]"
                >
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="relative flex size-2">
                      <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#FF3667] opacity-75"></span>
                      <span className="relative inline-flex size-2 rounded-full bg-[#FF3667]"></span>
                    </span>
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Digital Wallet
            </p>
          </div>
        </div>
      </div>
